...
public class Logger {
	...
	public static void info(Class<? extends Object> clz, String message) {
		Log log = LogFactory.getLog(clz.getName());
	...
	public static void infoAndTrace(Class<? extends Object> clz, String message) {
		info(clz, message);

		trace(clz, message);
	}

	private static void trace(Class<? extends Object> clz, String message) {
		Log log = LogFactory.getLog(clz.getName());
	...
	public static void debug(Class<? extends Object> clz, String message) {
		Log log = LogFactory.getLog(clz.getName());
